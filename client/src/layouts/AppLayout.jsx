...
const AppLayout = ({ children }) => {
  ...
  <div className="flex items-center justify-between gap-5">
    ...
    <button
      ...
      className="rounded-xl border border-white/10 bg-white/10 p-3 transition hover:bg-white/20 lg:hidden"
    >
      <Menu size={22} />
    </button>
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="relative">
        ...
        {showNotifications && (
  <div className="absolute right-0 z-50 mt-3 w-96 max-w-[90vw] overflow-hidden rounded-3xl border border-white/10 bg-slate-900 shadow-2xl shadow-black/40">
      ...
      {notifications.length === 0 ? (
        ...
        notifications.map((item) => (
          ...
          >
            ...
            <p className="mt-1 pr-6 text-sm text-slate-400 break-words whitespace-pre-wrap">
              {item.message}
            </p>
